              ...
              if (((expr.getTypeFilter() != null) && (expr.getBodyFilter() != null))) {
                ...
                if ((expr instanceof SeqExpr)) {
                  ...
                  if (((expr.getTypeSeq() != null) && (expr.getBodySeq() != null))) {
                    return ContractivenessCheck.isContractive(expr.getBodySeq(), (depth + 1), depth, assocT, assocD, threshold);
                  } else {
                      ...
                      if ((expr instanceof TerminalExpr)) {
                        ...
                        if (_tripleNotEquals) {
                          ...
                          if (_tripleNotEquals_1) {
                            ...
                            return ContractivenessCheck.isContractive(assocT.get(((TerminalExpr)expr).getTerminalExpr().getTerm().getName()), depth, deepestseq, assocT, assocD, threshold);
                          } else {
                        ...
                        if (_tripleNotEquals_4) {
                          ...
                          return ContractivenessCheck.isContractive(assocT.get(expr.getTerm().getName()), depth, deepestseq, assocT, assocD, threshold);
                        } else {
