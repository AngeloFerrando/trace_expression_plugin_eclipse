		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAgentTraceExpressionAccess().getAlternatives_5(), "rule__AgentTraceExpression__Alternatives_5");
					put(grammarAccess.getAgentTraceExpressionAccess().getDecentralizedAlternatives_5_4_1_0(), "rule__AgentTraceExpression__DecentralizedAlternatives_5_4_1_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGuiAlternatives_5_7_1_0(), "rule__AgentTraceExpression__GuiAlternatives_5_7_1_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getMinimalAlternatives_5_8_1_0(), "rule__AgentTraceExpression__MinimalAlternatives_5_8_1_0");
					...
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup(), "rule__AgentTraceExpression__Group__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_0(), "rule__AgentTraceExpression__Group_5_0__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_1(), "rule__AgentTraceExpression__Group_5_1__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_1_1(), "rule__AgentTraceExpression__Group_5_1_1__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_2(), "rule__AgentTraceExpression__Group_5_2__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_3(), "rule__AgentTraceExpression__Group_5_3__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_4(), "rule__AgentTraceExpression__Group_5_4__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_5(), "rule__AgentTraceExpression__Group_5_5__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_6(), "rule__AgentTraceExpression__Group_5_6__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_7(), "rule__AgentTraceExpression__Group_5_7__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_8(), "rule__AgentTraceExpression__Group_5_8__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_9(), "rule__AgentTraceExpression__Group_5_9__0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGroup_5_10(), "rule__AgentTraceExpression__Group_5_10__0");
					...
					put(grammarAccess.getGenericTraceExpressionAccess().getTypesLAssignment_5_1_0(), "rule__GenericTraceExpression__TypesLAssignment_5_1_0");
					put(grammarAccess.getGenericTraceExpressionAccess().getTypesAssignment_5_1_1(), "rule__GenericTraceExpression__TypesAssignment_5_1_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getNameAssignment_4(), "rule__AgentTraceExpression__NameAssignment_4");
					put(grammarAccess.getAgentTraceExpressionAccess().getBodyLAssignment_5_0_0(), "rule__AgentTraceExpression__BodyLAssignment_5_0_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getTermsAssignment_5_0_1(), "rule__AgentTraceExpression__TermsAssignment_5_0_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getRolesLAssignment_5_1_0(), "rule__AgentTraceExpression__RolesLAssignment_5_1_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getRolesAssignment_5_1_1_0(), "rule__AgentTraceExpression__RolesAssignment_5_1_1_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getTypesLAssignment_5_2_0(), "rule__AgentTraceExpression__TypesLAssignment_5_2_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getTypesAssignment_5_2_1(), "rule__AgentTraceExpression__TypesAssignment_5_2_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getModulesLAssignment_5_3_0(), "rule__AgentTraceExpression__ModulesLAssignment_5_3_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getModulesAssignment_5_3_1(), "rule__AgentTraceExpression__ModulesAssignment_5_3_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getDecentralizedLAssignment_5_4_0(), "rule__AgentTraceExpression__DecentralizedLAssignment_5_4_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getDecentralizedAssignment_5_4_1(), "rule__AgentTraceExpression__DecentralizedAssignment_5_4_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getPartitionLAssignment_5_5_0(), "rule__AgentTraceExpression__PartitionLAssignment_5_5_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getPartitionAssignment_5_5_1(), "rule__AgentTraceExpression__PartitionAssignment_5_5_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getConstraintsLAssignment_5_6_0(), "rule__AgentTraceExpression__ConstraintsLAssignment_5_6_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getConstraintsAssignment_5_6_1(), "rule__AgentTraceExpression__ConstraintsAssignment_5_6_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getGuiLAssignment_5_7_0(), "rule__AgentTraceExpression__GuiLAssignment_5_7_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getGuiAssignment_5_7_1(), "rule__AgentTraceExpression__GuiAssignment_5_7_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getMinimalLAssignment_5_8_0(), "rule__AgentTraceExpression__MinimalLAssignment_5_8_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getMinimalAssignment_5_8_1(), "rule__AgentTraceExpression__MinimalAssignment_5_8_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getThresholdLAssignment_5_9_0(), "rule__AgentTraceExpression__ThresholdLAssignment_5_9_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getThresholdAssignment_5_9_1(), "rule__AgentTraceExpression__ThresholdAssignment_5_9_1");
					put(grammarAccess.getAgentTraceExpressionAccess().getChannelsLAssignment_5_10_0(), "rule__AgentTraceExpression__ChannelsLAssignment_5_10_0");
					put(grammarAccess.getAgentTraceExpressionAccess().getChannelsAssignment_5_10_1(), "rule__AgentTraceExpression__ChannelsAssignment_5_10_1");
